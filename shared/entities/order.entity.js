...
const proforma_invoice_entity_1 = require("./proforma-invoice.entity");
var OrderStatus;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => delivery_address_entity_1.DeliveryAddress, { onDelete: 'SET NULL' }),
    (0, typeorm_1.JoinColumn)({ name: 'deliveryAddressId' }),
    __metadata("design:type", delivery_address_entity_1.DeliveryAddress)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => proforma_invoice_entity_1.ProformaInvoice, (proformaInvoice) => proformaInvoice.order),
    __metadata("design:type", Array)
], Order.prototype, "proformaInvoices", void 0);
__decorate([
